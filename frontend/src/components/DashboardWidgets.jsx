      ...
      {inProgressQuiz && (
        <aside className="card" style={{ padding: '1.25rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.75rem' }}>
            <span style={{ fontWeight: 800, fontSize: '0.9rem', color: '#222222' }}>
              Bài làm chưa nộp
            </span>
            ...
            recentFiles.map(q => (
              ...
              >
                <div style={{ display: 'flex', flexDirection: 'column', minWidth: 0 }}>
                  <span style={{ fontSize: '0.825rem', fontWeight: 700, color: '#222222', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                    {q.title || q.filename}
                  </span>
